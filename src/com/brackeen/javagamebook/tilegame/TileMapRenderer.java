...
public class TileMapRenderer {
    ...
    */
        ...
        int screenWidth, int screenHeight)
    {
        ...
        Font font1 = new Font("Italian", Font.BOLD, 24);
        String str1 = new String("Char "+Integer.toString((int)temp.getH()));
        TextLayout textLayout = new TextLayout(str1, font1, frc);
        g.setColor(Color.red);
        textLayout.draw(g, 80, 70);
    }
