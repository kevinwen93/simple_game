...
public class ResourceManager {
    ...
    */
    ...
    public static Animation createBulletAnim(Image img1) {
        Animation anim = new Animation();
        anim.addFrame(img1, 10);
        return anim;
    }
    ...
    private void loadPowerUpSprites() {
        ...
        anim = new Animation();
        anim.addFrame(loadImage("mario_mushroom_mini.png"), 150);
        anim.addFrame(loadImage("mario_mushroom_mini2.png"), 150);
        anim.addFrame(loadImage("mario_mushroom_mini3.png"), 150);
        anim.addFrame(loadImage("mario_mushroom_mini2.png"), 150);
